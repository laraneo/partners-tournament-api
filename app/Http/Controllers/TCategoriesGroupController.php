...
use App\Services\TCategoriesGroupService;
use Barryvdh\DomPDF\Facade as PDF;

class TCategoriesGroupController extends Controller
{
    public function __construct(TCategoriesGroupService $service)
	{
